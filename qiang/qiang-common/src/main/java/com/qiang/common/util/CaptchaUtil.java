...
public class CaptchaUtil {
    ...
    private  void  createImage(){
        ...
        String str1 = randomStr(codeCount);//得到随机数
        this.code = str1;
    ...
    private String randomStr(int n){
        String str1 = "ABCDEFGHIJKLMNOPQRSTUVWXWYZabcdefghijklmnopqrstuvwxyz1234567890";
        String str2 = "";
    ...
    //得到随机颜色
    private  Color getRandColor(int fc,int bc){//给定饭为获得随机颜色
        if(fc>255){
            fc=255;
        }
        if(bc>255){
