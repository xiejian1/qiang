...
public class MybatisGeneratorUtil {
    ...
    public static void generator(
        ...
        String sql = "SELECT table_name FROM INFORMATION_SCHEMA.TABLES WHERE table_schems = '" +database+ " 'AND table_name LIKE '" + tableprefix+"_% ';";
        System.out.println("=============开始生成generratorConfig.xml文件===================");
        ...
        try {
            ...
            List<Map> result = jdbcUtil.selectByParans(sql, null);
            for (Map map : result) {
            ...
            context.put("generator_jdb_password",AESUtil.aesEncode(jdbcPassword));
        ...
        System.out.println("==========================结束生成generatorConfig.xml==================");
        ...
        String servicePath = basePath + module + "/" + module + "-rpc-service" + "/src/main/java/" + packageName.replaceAll("\\.","/") + "/rpc/service/impl";
        for(int i = 0;i<tables.size();i++){
            ...
            if (!serviceImplFile.exists()){
                ...
                context.put("ctime",ctime);
                VelocityUtil.generate(serviceImpl_vm,serviceMock,context);
                System.out.println(serviceMock);
            }
        }
